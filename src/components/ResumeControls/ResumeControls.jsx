...
const ResumeControls = ({ save, setSelectedFont, selectedFont, setFontSizes, fontSizes }) => {
  ...
  return (
    <Flex borderRadius={'10px'} m={'0.5rem'} p={'0.5rem'} bg={'blue.900'} mb={'0.3rem'} w={'full'} justifyContent={'center'} gap={'0.5rem'} flexWrap="wrap">
     ...
     <Select       border={"1px solid #002244"} borderRadius={'15px'} value={selectedFont} onChange={handleFontChange} placeholder="Select Font Family">
    ...
    <Select  border={"1px solid #002244"}  borderRadius={'15px'}  value={"header"} onChange={(e) => handleFontSizeChange(e, 'header')} placeholder="Header Font Size">
   ...
   <Select  border={"1px solid #002244"}  borderRadius={'15px'}  value={"subheader"} onChange={(e) => handleFontSizeChange(e, 'subheading')} placeholder="Subheading Font Size">
   ...
   <Select  border={"1px solid #002244"}  borderRadius={'15px'} value={"name"} onChange={(e) => handleFontSizeChange(e, 'name')} placeholder="Name Font Size">
  ...
  <Select  border={"1px solid #002244"}  borderRadius={'15px'}  value={"description"} onChange={(e) => handleFontSizeChange(e, 'description')} placeholder="Description Font Size">
